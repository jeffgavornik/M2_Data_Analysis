...
normalizeByGroupMean(vdo,'Exp Day4','Exp Day3');
normalizeByGroupMean(vdo,'Exp Day5','Exp Day3');
...
normalizeByGroupMean(vdo,'Ctrl Day4','Ctrl Day3');
normalizeByGroupMean(vdo,'Ctrl Day5','Ctrl Day3');
...
%%
fh = figure;
violinPlotGroupData(ctrlGrps{1},expGrps{1},ctrlGrps{2},expGrps{2},...
    ctrlGrps{3},expGrps{3},'ClipRange',false,'Bandwidth',30);
ylim([0 600]);
savePlotToFile(fh,fullfile(figPath,'M2_ExpVsCtrl_Days1to3_Violin'),'-depsc');

%%
fh = figure;
violinPlotGroupData(ctrlGrps{1},expGrps{3},ctrlGrps{2},expGrps{4},...
    ctrlGrps{3},expGrps{5},'ClipRange',false,'Bandwidth',30);
ylim([0 600]);
savePlotToFile(fh,fullfile(figPath,'M2_ExpVsCtrl_Day3to5_Violin'),'-depsc');
...
legend(phs,legStrs);
fh = prettyPlotFromExistingPlot(fh,true,[100 100],{'ms' '\muV'});
savePlotToFile(fh,fullfile(figPath,'M2_ExpDays3to5'),'-depsc');
...
legend(phs,legStrs);
fh = prettyPlotFromExistingPlot(fh,true,[100 100],{'ms' '\muV'});
savePlotToFile(fh,fullfile(figPath,'M2_CtrlDays3to5'),'-depsc');
