...
% vdo.removeSpecifiersFromAllGroups('330042o2' ,'seqday4',{'Dcba','dCba','dcBa','dcbA' 'DCBA'},[]);
vdo.removeSpecifiersFromAllGroups([],'seqday4',[],[]);
...
vs = violinPlotGroupData(expABCDGrp,expDCBAGrp,...
    ctrlABCDGrp,ctrlDCBAGrp,'ClipRange',false,'Bandwidth',50);
ylim([0 800]);
savePlotToFile(fh,fullfile(figPath,'M2_SeqFX_Violin'),'-depsc');
...
savePlotToFile(fh,fullfile(figPath,'M2_SeqFX_ExpCtrlABCD'),'-depsc');
...
fh = prettyPlotFromExistingPlot(fh,true,[100 100],{'ms' '\muV'});
savePlotToFile(fh,fullfile(figPath,'M2_SeqFX_ExpCtrlDCBA'),'-depsc');
...
fh = prettyPlotFromExistingPlot(fh,true,[100 100],{'ms' '\muV'});
savePlotToFile(fh,fullfile(figPath,'M2_SeqFX_ExpABCDDCBA'),'-depsc');
...
fh = prettyPlotFromExistingPlot(fh,true,[100 100],{'ms' '\muV'});
savePlotToFile(fh,fullfile(figPath,'M2_SeqFX_CtrlABCDDCBA'),'-depsc');
